"""Start page for the mydashtwo application."""
...
from mydashtwo.config.main import STORE_ID, PROJECT_NAME, PROJECT_SLUG
from mydashtwo.project import Project, start
